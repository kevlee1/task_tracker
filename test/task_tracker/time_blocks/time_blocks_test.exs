defmodule TaskTracker.TimeBlocksTest do
  ...
  describe "time_block" do
    ...
    test "create_time_block/1 with valid data creates a time_block" do
      ...
      assert time_block.endTime == DateTime.from_naive!(~N[2010-04-17 14:00:00.000000Z], "Etc/UTC")
      assert time_block.startTime == DateTime.from_naive!(~N[2010-04-17 14:00:00.000000Z], "Etc/UTC")
    end
    ...
    test "update_time_block/2 with valid data updates the time_block" do
      ...
      assert time_block.endTime == DateTime.from_naive!(~N[2011-05-18 15:01:01.000000Z], "Etc/UTC")
      assert time_block.startTime == DateTime.from_naive!(~N[2011-05-18 15:01:01.000000Z], "Etc/UTC")
    end
